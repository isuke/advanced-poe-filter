...
################################################################################
#                                                                              #
# Created By Advanced PoE Filter (Ver: 0.8.1)                                  #
#                                                                              #
################################################################################
...
Show
  ...
  const generator = new Generator(scriptObject, '0.8.1')
...
Hide
  ...
  const generator = new Generator(scriptObject, '0.8.1', '', '', { addDisableDropSoundToHideBlock: true })
  const result = generator.generate()
...
Show
  ...
  const generator = new Generator(scriptObject, '0.8.1', '', '', { convertPlayAlertSoundPositionalToPlayAlertSound: true })
  const result = generator.generate()
...
Show
  ...
  const generator = new Generator(scriptObject, '0.8.1', '', '', { removeCustomAlertSound: true })
  const result = generator.generate()
...
Show
  ...
  const generator = new Generator(scriptObject, '0.8.1', '', '', { initialFontSize: 38 })
  const result = generator.generate()
