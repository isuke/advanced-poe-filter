...
Show
  ...
  const generator = new Generator(scriptObject, '0.8.0')
...
Hide
  ...
  const generator = new Generator(scriptObject, '0.8.0', '', '', { addDisableDropSoundToHideBlock: true })
  const result = generator.generate()
...
Show
  ...
  const generator = new Generator(scriptObject, '0.8.0', '', '', { convertPlayAlertSoundPositionalToPlayAlertSound: true })
  const result = generator.generate()
...
Show
  ...
  const generator = new Generator(scriptObject, '0.8.0', '', '', { removeCustomAlertSound: true })
  const result = generator.generate()
...
Show
  ...
  const generator = new Generator(scriptObject, '0.8.0', '', '', { initialFontSize: 38 })
  const result = generator.generate()
